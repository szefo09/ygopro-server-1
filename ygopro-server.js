...
(function() {
  ...
  ygopro.ctos_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var buffer_handle_callback, buffer_pos, check_buffer_indentity, len2, len3, len4, len5, len6, len7, len8, line, m, match_permit_callback, n, name, o, oppo_pos, p, player, player_string, pre_room, q, r, ref3, ref4, ref5, ref6, ref7, replay_id, room, room_buffer, room_players, room_showed, s;
    ...
    if (CLIENT_is_able_to_reconnect(client) || CLIENT_is_able_to_kick_reconnect(client)) {
      ...
      match_permit_callback = function(buffer, match_permit) {
        var decrypted_buffer, i, id, len5, p, ref4, secret;
        if (client.closed) {
          return;
        }
        ...
        challonge.participants._index({
          ...
          callback: function(err, data) {
            ...
            challonge.matches._index({
              id: settings.modules.challonge.tournament_id,
              callback: function(err, data) {
                var len6, len7, len8, len9, line, match, q, r, ref5, ref6, ref7, ref8, s, t;
                if (client.closed) {
                  return;
                }
                if (err || !data) {
  ...
  wait_room_start_arena = function(room) {
    var display_name, len2, m, player, ref3;
  ...
  ygopro.stoc_follow('DUEL_START', false, function(buffer, info, client, server, datas) {
    var deck_arena, deck_name, deck_text, len2, len3, m, n, player, ref3, ref4, room;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
  ...
  if (settings.modules.http) {
    ...
    requestListener = function(request, response) {
      var archive_args, archive_name, archive_process, check, death_room_found, duellog, error, filename, getpath, key, kick_room_found, len2, len3, len4, len5, len6, len7, len8, m, n, o, p, parseQueryString, pass_validated, player, q, r, ref3, ref4, replay, ret_keys, room, roomsjson, s, u;
