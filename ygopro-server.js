...
(function() {
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server) {
    var card, chain, check, count, cpos, deck_found, found, hint_type, i, id, len2, len3, len4, len5, len6, limbo_found, line, loc, m, max_loop, msg, n, o, oppo_pos, p, phase, player, playertype, pos, ppos, q, r, r_player, reason, ref2, ref3, ref4, ref5, ref6, ref7, ref8, room, trigger_location, val, win_pos;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
      ...
      if (ygopro.constants.MSG[msg] === 'SUMMONING' || ygopro.constants.MSG[msg] === 'SPSUMMONING' || ygopro.constants.MSG[msg] === 'CHAINING') {
        ...
        if (ygopro.constants.MSG[msg] !== 'CHAINING' || (trigger_location & 0x8) && client.ready_trap) {
          if (dialogues.dialogues[card]) {
            ...
            ref8 = _.lines(dialogues.dialogues_custom[card][Math.floor(Math.random() * dialogues.dialogues_custom[card].length)]);
