...
// support web given format
  ...
  net.createServer(function(client) {
    ...
    client.on('data', function(ctos_buffer) {
      var b, bad_ip_count, buffer, cancel, ctos_event, ctos_message_length, ctos_proto, datas, info, len3, len4, len5, len6, looplimit, n, o, p, q, ref4, ref5, result, room, struct;
      if (client.is_post_watcher) {
        room = ROOM_all[client.rid];
          ...
          if (ctos_message_length === 0) {
            ...
            if (ctos_buffer.length >= 2 + ctos_message_length) {
              ...
              if (ygopro.ctos_follows_before[ctos_proto] && !cancel) {
                ref4 = ygopro.ctos_follows_before[ctos_proto];
                for (n = 0, len3 = ref4.length; n < len3; n++) {
                  ctos_event = ref4[n];
              ...
              if (ygopro.ctos_follows_after[ctos_proto] && !cancel) {
                ref5 = ygopro.ctos_follows_after[ctos_proto];
                for (o = 0, len4 = ref5.length; o < len4; o++) {
                  ctos_event = ref5[o];
                  result = ctos_event.callback(b, info, client, client.server, datas);
                  if (result && ctos_event.synchronous) {
    ...
    server.on('data', function(stoc_buffer) {
      var b, buffer, cancel, datas, info, len3, len4, len5, looplimit, n, o, p, ref4, ref5, result, stoc_event, stoc_message_length, stoc_proto, struct;
        ...
        if (stoc_message_length === 0) {
          ...
          if (stoc_buffer.length >= 2 + stoc_message_length) {
            ...
            if (ygopro.stoc_follows_before[stoc_proto] && !cancel) {
              ref4 = ygopro.stoc_follows_before[stoc_proto];
              for (n = 0, len3 = ref4.length; n < len3; n++) {
                stoc_event = ref4[n];
            ...
            if (ygopro.stoc_follows_after[stoc_proto] && !cancel) {
              ref5 = ygopro.stoc_follows_after[stoc_proto];
              for (o = 0, len4 = ref5.length; o < len4; o++) {
                stoc_event = ref5[o];
                result = stoc_event.callback(b, info, server.client, server, datas);
                if (result && stoc_event.synchronous) {
