...
// support web given format
  ...
  Room = class Room {
    ...
    finish_recover(fail) {
      var buffer, len2, m, player, ref3, results;
      if (fail) {
  ...
  ygopro.ctos_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var available_logs, check_buffer_indentity, create_room_with_action, len2, len3, len4, len5, line, m, n, name, o, p, pre_room, ref3, ref4, ref5, ref6, replay_id, room;
    //log.info info
