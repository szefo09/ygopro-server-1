...
(function() {
  ...
  replace_buffer = global.replace_buffer = function(buffer, list, start_pos) {
  ...
  net.createServer(function(client) {
    ...
    client.on('data', function(ctos_buffer) {
      var b, bad_ip_count, buffer, cancel, ctos_event, ctos_message_length, ctos_proto, datas, info, len3, len4, len5, len6, looplimit, m, n, o, p, ref3, ref4, result, room, struct;
      if (client.is_post_watcher) {
        room = ROOM_all[client.rid];
        ...
        if (client.established) {
          ...
          for (p = 0, len6 = datas.length; p < len6; p++) {
            buffer = datas[p];
    ...
    server.on('data', function(stoc_buffer) {
      var b, buffer, cancel, datas, info, len3, len4, len5, looplimit, m, n, o, ref3, ref4, result, stoc_event, stoc_message_length, stoc_proto, struct;
  ...
  ygopro.ctos_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var buffer_handle_callback, buffer_pos, check_buffer_indentity, len3, len4, len5, len6, len7, len8, len9, line, m, match_permit_callback, n, name, o, oppo_pos, p, player, player_string, pre_room, q, r, ref3, ref4, ref5, ref6, ref7, replay_id, room, room_buffer, room_players, room_showed, s;
    ...
    if (CLIENT_is_able_to_reconnect(client) || CLIENT_is_able_to_kick_reconnect(client)) {
      ...
      match_permit_callback = function(buffer, match_permit) {
        var decrypted_buffer, i, id, len6, p, ref4, secret;
        if (client.closed) {
          return;
        }
        ...
        challonge.participants._index({
          ...
          callback: function(err, data) {
            ...
            challonge.matches._index({
              id: settings.modules.challonge.tournament_id,
              callback: function(err, data) {
                var len10, len7, len8, len9, line, match, q, r, ref5, ref6, ref7, ref8, s, t;
                if (client.closed) {
                  return;
                }
                if (err || !data) {
  ...
  if (settings.modules.mycard.enabled) {
    setInterval(function() {
      var len3, len4, m, n, player, room, time_passed, waited_time;
      for (m = 0, len3 = ROOM_all.length; m < len3; m++) {
        room = ROOM_all[m];
  ...
  if (settings.modules.http) {
    ...
    requestListener = function(request, response) {
      var archive_args, archive_name, archive_process, check, death_room_found, duellog, error, filename, getpath, key, kick_room_found, len3, len4, len5, len6, len7, len8, len9, m, n, o, p, parseQueryString, pass_validated, player, q, r, ref3, ref4, replay, ret_keys, room, roomsjson, s, u;
      ...
      if (u.pathname === '/api/getrooms') {
        ...
        if (u.query.shout) {
          ...
          for (s = 0, len9 = ROOM_all.length; s < len9; s++) {
            room = ROOM_all[s];
            if (!(room)) {
              continue;
            }
