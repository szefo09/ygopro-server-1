...
(function() {
  ...
  CLIENT_use_cdkey = function(client, pkey) {
    var current_date, found_type, index, j, key, keys, len1, new_vip, ref, type;
  ...
  ban_user = function(name) {
    var bad_ip, len3, len4, m, n, player, ref3, room;
  ...
  CLIENT_import_data = function(client, old_client, room) {
    var index, key, len3, len4, m, n, player, ref3;
    ref3 = room.players;
    for (index = m = 0, len3 = ref3.length; m < len3; index = ++m) {
      player = ref3[index];
    ...
    for (n = 0, len4 = import_datas.length; n < len4; n++) {
      key = import_datas[n];
  ...
  CLIENT_is_player = function(client, room) {
    var is_player, len3, m, player, ref3;
    is_player = false;
    ref3 = room.players;
    for (m = 0, len3 = ref3.length; m < len3; m++) {
      player = ref3[m];
  ...
  CLIENT_get_kick_reconnect_target = function(client, deckbuf) {
    var len3, len4, m, n, player, ref3, room;
    for (m = 0, len3 = ROOM_all.length; m < len3; m++) {
      room = ROOM_all[m];
  ...
  CLIENT_send_pre_reconnect_info = function(client, room, old_client) {
    var len3, m, player, ref3, req_pos;
  ...
  Room = (function() {
    function Room(name, hostinfo) {
      var draw_count, error, lflist, list_official_to_pre, list_pre_to_official, official_database, param, pre_release_database, rule, start_hand, start_lp, temp_list, time_limit;
    ...
    Room.prototype.send_replays = function() {
      var len3, len4, m, n, player, ref3, ref4;
  ...
  net.createServer(function(client) {
    ...
    client.on('data', function(ctos_buffer) {
      var b, bad_ip_count, buffer, cancel, ctos_message_length, ctos_proto, datas, info, len3, len4, looplimit, m, n, room, struct;
      if (client.is_post_watcher) {
        room = ROOM_all[client.rid];
    ...
    server.on('data', function(stoc_buffer) {
      var b, buffer, cancel, datas, info, len3, looplimit, m, stanzas, stoc_message_length, stoc_proto, struct;
  ...
  ygopro.ctos_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var buffer_pos, check, decrypted_buffer, finish, i, id, len10, len3, len4, len5, len6, len7, len8, len9, line, m, n, name, o, oppo_pos, p, player, player_string, pre_room, q, r, ref3, ref4, ref5, ref6, ref7, ref8, replay_id, room, room_buffer, room_players, room_showed, s, secret, t;
    ...
    if (CLIENT_is_able_to_reconnect(client) || CLIENT_is_able_to_kick_reconnect(client)) {
      ...
      buffer_pos += 2;
      for (n = 0, len4 = room_showed.length; n < len4; n++) {
        room = room_showed[n];
      ...
      finish = function(buffer) {
        var action, len6, len7, len8, len9, line, name, opt1, opt2, opt3, options, p, q, r, ref4, ref5, ref6, ref7, s, title;
        if (client.closed) {
          return;
        }
        ...
        challonge.participants._index({
          ...
          callback: function(err, data) {
            ...
            challonge.matches._index({
              id: settings.modules.challonge.tournament_id,
              callback: function(err, data) {
                var len10, len11, len8, len9, line, match, r, ref6, ref7, ref8, ref9, s, t, x;
                if (client.closed) {
                  return;
                }
                if (err || !data) {
                ...
                if (!room) {
                  ...
                  for (x = 0, len11 = ref9.length; x < len11; x++) {
                    player = ref9[x];
  ...
  ygopro.stoc_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var len3, len4, len5, line, m, n, o, player, recorder, ref3, ref4, ref5, room, watcher;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server, datas) {
    ...
    if (settings.modules.heartbeat_detection.enabled && client.pos === 0) {
      if (ygopro.constants.MSG[msg] === 'CHAINING') {
        ...
        found = false;
        for (q = 0, len6 = long_resolve_cards.length; q < len6; q++) {
      ...
      if (ygopro.constants.MSG[msg] === 'SUMMONING' || ygopro.constants.MSG[msg] === 'SPSUMMONING' || ygopro.constants.MSG[msg] === 'CHAINING') {
        ...
        if (ygopro.constants.MSG[msg] !== 'CHAINING' || (trigger_location & 0x8) && client.ready_trap) {
          if (settings.modules.vip.enabled && room.dueling_players[act_pos].vip && vip_info.players[room.dueling_players[act_pos].name].dialogues[card]) {
            ...
            for (x = 0, len10 = ref12.length; x < len10; x++) {
              line = ref12[x];
              ygopro.stoc_send_chat(client, line, ygopro.constants.COLORS.PINK);
            }
            ...
            for (y = 0, len11 = ref13.length; y < len11; y++) {
              line = ref13[y];
              ygopro.stoc_send_chat(client, line, ygopro.constants.COLORS.PINK);
            }
          }
  ...
  ygopro.stoc_follow('REPLAY', true, function(buffer, info, client, server, datas) {
    var duellog, dueltime, i, len3, len4, m, n, player, ref3, ref4, replay_filename, room;
    room = ROOM_all[client.rid];
    if (!room) {
    ...
    requestListener = function(request, response) {
      ...
      if (u.pathname === '/api/getrooms') {
        ...
        if (u.query.shout) {
          ...
          for (p = 0, len6 = ROOM_all.length; p < len6; p++) {
            room = ROOM_all[p];
          ...
          for (q = 0, len7 = ROOM_all.length; q < len7; q++) {
            room = ROOM_all[q];
          ...
          death_room_found = false;
          for (r = 0, len8 = ROOM_all.length; r < len8; r++) {
            room = ROOM_all[r];
