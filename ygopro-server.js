...
// support web given format
  ...
  ban_user = global.ban_user = async function(name) {
    var ban, bans, len3, len4, len5, len6, n, o, p, player, playerType, q, ref4, ref5, room;
    if (!settings.modules.mysql.enabled) {
    ...
    for (n = 0, len3 = ROOM_all.length; n < len3; n++) {
      ...
      if (room && room.established) {
        ref4 = ["players", "watchers"];
        for (o = 0, len4 = ref4.length; o < len4; o++) {
          playerType = ref4[o];
          ref5 = room[playerType];
  ...
  Room = class Room {
    ...
    delete() {
      var end_time, formatted_replays, index, len3, log_rep_id, n, name, player_datas, recorder_buffer, ref4, ref5, repbuf, replay_id, room_name, score, score_array, score_form;
      if (this.deleted) {
        return;
      }
  ...
  ygopro.ctos_follow('JOIN_GAME', true, async function(buffer, info, client, server, datas) {
    var available_logs, check_buffer_indentity, create_room_with_action, exactBan, index, len3, len4, len5, len6, len7, line, n, name, o, p, pre_room, q, r, recover_match, ref4, ref5, ref6, ref7, replay, replay_id, replays, room, struct;
    //log.info info
    ...
    if (CLIENT_is_able_to_reconnect(client) || CLIENT_is_able_to_kick_reconnect(client)) {
      ...
      check_buffer_indentity = function(buf) {
        var checksum, i, o, ref4;
        checksum = 0;
        for (i = o = 0, ref4 = buf.length; (0 <= ref4 ? o < ref4 : o > ref4); i = 0 <= ref4 ? ++o : --o) {
          checksum += buf.readUInt8(i);
        }
        return (checksum & 0xFF) === 0;
      };
      create_room_with_action = async function(buffer, decrypted_buffer, match_permit) {
        var action, len4, len5, len6, len7, line, name, o, opt1, opt2, opt3, options, p, player, q, r, ref4, ref5, ref6, ref7, room, room_title, title;
        if (client.closed) {
          return;
        }
      ...
      _async.auto({
        ...
        get_user: function(done) {
          var decrypted_buffer, i, id, len4, o, ref4, secret;
          if (client.closed) {
            done();
            return;
          }
      ...
      if (pre_room && pre_room.duel_stage !== ygopro.constants.DUEL_STAGE.BEGIN && settings.modules.cloud_replay.enable_halfway_watch && !pre_room.hostinfo.no_watch) {
        ...
        _async.auto({
          ...
          var create_room_name, found, len5, len6, len7, len8, line, match, p, player, q, r, ref10, ref5, ref6, ref7, ref8, ref9, s, user;
          if (client.closed) {
            return;
          }
  ...
  ygopro.stoc_follow('HS_PLAYER_CHANGE', true, async function(buffer, info, client, server, datas) {
    var is_ready, len3, n, p1, p2, player, pos, possibly_max_player, ref4, room;
    room = ROOM_all[client.rid];
