...
(function() {
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server) {
    var card, count, cpos, hint_type, len2, len3, line, loc, m, msg, n, oppo_pos, phase, playertype, pos, ppos, reason, ref2, ref3, ref4, ref5, room, trigger_location, val, win_pos;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
